...
class TestPortfolioBootstrapPortfolioIntegration(unittest.TestCase):
    def test_portfolio_uses_bootstrap_readiness(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
                        ...
                        "onboarding_records": [
                            {
                                ...
                                "readiness_estimate": 72,
                                "onboarding_state": "assessed",
                                "metadata": {},
                            }
                        ]
                    }
            ...
            status = report["repository_statuses"][0]
            self.assertGreaterEqual(int(status["readiness_score"]), 72)
