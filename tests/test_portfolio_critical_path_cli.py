...
from portfolio_critical_path.cli import main  # noqa: E402


class TestPortfolioCriticalPathCli(unittest.TestCase):
    def test_cli(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertIn("Portfolio Critical Path", out.getvalue())
            self.assertTrue((root / ".control_plane" / "portfolio_critical_path" / "latest.json").exists())
